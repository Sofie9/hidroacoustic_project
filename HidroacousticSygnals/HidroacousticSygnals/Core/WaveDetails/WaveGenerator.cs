            ...
            try
            {
                ...
                for (int i = 0; i < numSamples; i++)
                {
                    ...
                    for (var n = bottom; n <= top; n++)
                    {
                        ...
                        var waveLength = 6.72 / this.core.Frequency;
                    ...
                    dataChunk.shortArray[i] = (short)Convert.ToInt16(Math.Round(Vx*1000));
                    dataChunk.shortArray[i+1] = (short)Convert.ToInt16(Vy * 1000);
                    dataChunk.shortArray[i+2] = (short)Convert.ToInt16(Math.Round(Vz * 1000));
                    dataChunk.shortArray[i+3] = (short)Convert.ToInt16(Math.Round(p * 1000));
